    ...
    return (
        <HomePageStyled>
            ...
            <div className="typography">
                <h1>Hola, Soy <span>Odalis Valencia</span></h1>
                <p>
                ...
                <div className="icons">
                    <a href="https://www.facebook.com/vale.valencia.908" className="icon i-facebook">
                        <FacebookIcon />
                    </a>
                    <a href="https://github.com/odalisvalencia" className="icon i-github">
                        <GithubIcon />
                    </a>
                </div>
            </div>
